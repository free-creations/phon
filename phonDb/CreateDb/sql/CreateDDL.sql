...
-- -----------------------------------------------------------------------------
-- Table G R O U P
-- The participants might be joined into crews.
-- -----------------------------------------------------------------------------
CREATE TABLE "APP"."CREW" (
  "CREW" INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY,
  "NAME" VARCHAR(50)
);
-- -----------------------------------------------------------------------------
-- -----------------------------------------------------------------------------
...
ALTER TABLE "APP"."CREW" 
  ADD CONSTRAINT "CrewPrimKey" PRIMARY KEY ("CREW");
...
ALTER TABLE "APP"."PERSON" 
  ADD CONSTRAINT "PERSON_FK2" FOREIGN KEY ("CREW") 
  REFERENCES "APP"."CREW" ("CREW") ON DELETE NO ACTION ON UPDATE NO ACTION;

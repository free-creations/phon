...
-- -----------------------------------------------------------------------------
-- Table G R O U P
-- The participants might be joined into groups.
-- -----------------------------------------------------------------------------
CREATE TABLE "APP"."GROUP" (
  "GROUP" INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY,
  "NAME" VARCHAR(50)
);
-- -----------------------------------------------------------------------------
-- -----------------------------------------------------------------------------
...
ALTER TABLE "APP"."GROUP" 
  ADD CONSTRAINT "GroupPrimKey" PRIMARY KEY ("GROUP");
...
ALTER TABLE "APP"."PERSON" 
  ADD CONSTRAINT "PERSON_FK2" FOREIGN KEY ("GROUP") 
  REFERENCES "APP"."GROUP" ("GROUP") ON DELETE NO ACTION ON UPDATE NO ACTION;
